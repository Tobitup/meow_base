...
VALID_EMAIL_CHARS = CHAR_UPPERCASE + CHAR_LOWERCASE + CHAR_NUMERIC + "(),:;<>@[\].!#$%&'*+-/=?^_`{|}~"
...
VALID_REGEX_CHARS = CHAR_UPPERCASE + CHAR_LOWERCASE + CHAR_NUMERIC + ".,;:'^$×+*?|{}[]()-_\/"
...
NOTIFICATION_KEYS = [NOTIFICATION_EMAIL, NOTIFICATION_MSG]
